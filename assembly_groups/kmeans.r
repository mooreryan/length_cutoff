...
## plot(mydata, pch=20, main='K-means clustering (3)')
...
## aggregate(mydata, by=list(mydata$fit.cluster), mean)[1:4]
## aggregate(mydata, by=list(mydata$fit.cluster), sd)[1:4]

## best.clusters <- subset(mydata, fit.cluster==3 | fit.cluster==2)


## with(best.clusters, plot(N50 ~ TotalContigs, type='n'))
## with(subset(best.clusters, fit.cluster==2),
##      points(N50  ~ TotalContigs, col='blue', pch=20))
## with(subset(best.clusters, fit.cluster==3),
##      points(N50  ~ TotalContigs, col='red', pch=20))

## plot(mydata, pch=20, main='K-means clustering (5)')
...
## plot(mydata, pch=20, main='K-means clustering')
